...
class assign {
    ...
    public function add_instance(stdClass $formdata, $callplugins) {
        ...
        $assign_obe = new stdClass();
        $assign_obe->assignment = $returnid;
        $assign_obe->obe_category = $formdata->obe_category;
        $DB->insert_record('assign_obe', $assign_obe);
    ...
    */
    ...
    public function update_instance($formdata) {
        ...
        $assign_obe = new stdClass();
        $assign_obe->assignment = $formdata->instance;
        $assign_obe->obe_category = $formdata->obe_category;

        if ($assign_obe = $DB->get_record('assign_obe', array('assignment' => $assign_obe->assignment))) {
            $assign_obe->obe_category = $formdata->obe_category;
            $DB->update_record('assign_obe', $assign_obe);
        }
