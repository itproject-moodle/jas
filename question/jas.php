...
$category = $pagevars['cat'];	// get category from dropdown
...
$questionbank->display('questions', $pagevars['cat']);

echo '<form action="upload.php?courseid='.$course_id.'" method="post" enctype="multipart/form-data"> <input type="file" name="fileToUpload" id="fileToUpload"><input type="submit" value="Upload PDF" name="submit"></form>';
