...
function question_extend_settings_navigation(navigation_node $navigationnode, $context) {
    ...
    if ($contexts->have_one_edit_tab_cap('upload')) {
        $questionnode->add(get_string('upload', 'local_myplugin'), new moodle_url(
                '/question/jas.php', $params), navigation_node::TYPE_SETTING);
    }
...
class question_edit_contexts {
    ...
    public static $caps = array(
        ...
        'upload'=>array('moodle/question:add'),
...
function question_page_type_list($pagetype, $parentcontext, $currentcontext) {
    ...
    $types = array(
        ...
        'question-upload'=>get_string('page-question-upload', 'question'),
